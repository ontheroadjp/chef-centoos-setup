...
sh ./docker/modules/start_docker.sh
sh ./docker/modules/start_chef.sh
sh ./docker/modules/docker_chef_all.sh
sh ./docker/modules/exec_serverspec.sh
sh ./docker/modules/stop_chef.sh
sh ./docker/modules/stop_docker.sh
